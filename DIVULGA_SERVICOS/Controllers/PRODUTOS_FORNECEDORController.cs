...
{
    public class PRODUTOS_FORNECEDORController : Controller
    {
        private PRINCIPAL db = new PRINCIPAL();

        // GET: PRODUTOS_FORNECEDOR
        ...
        // GET: PRODUTOS_FORNECEDOR/Details/5
        ...
        // GET: PRODUTOS_FORNECEDOR/Create
        ...
        // POST: PRODUTOS_FORNECEDOR/Create
        ...
        // GET: PRODUTOS_FORNECEDOR/Edit/5
        ...
        // POST: PRODUTOS_FORNECEDOR/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PRODUTOS_FORNECEDOR/Delete/5
        ...
        // POST: PRODUTOS_FORNECEDOR/Delete/5
