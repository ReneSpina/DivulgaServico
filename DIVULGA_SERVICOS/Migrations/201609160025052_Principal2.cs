namespace DIVULGA_SERVICOS.Migrations
{
    ...
    public partial class Principal2 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        CD_PESSOA = c.String(nullable: false, maxLength: 128),
                        SQ_ENDERECO = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        ClaimType = c.String(),
                        ClaimValue = c.String(),
                        CAD_PESSOA_CD_PESSOA = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.CAD_PESSOA_CD_PESSOA)
                .Index(t => t.CAD_PESSOA_CD_PESSOA);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AspNetUserRoles", "CAD_PESSOA_CD_PESSOA", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "CAD_PESSOA_CD_PESSOA", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "CAD_PESSOA_CD_PESSOA", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.AspNetUserRoles", new[] { "CAD_PESSOA_CD_PESSOA" });
            DropIndex("dbo.AspNetUserLogins", new[] { "CAD_PESSOA_CD_PESSOA" });
            DropIndex("dbo.AspNetUserClaims", new[] { "CAD_PESSOA_CD_PESSOA" });
