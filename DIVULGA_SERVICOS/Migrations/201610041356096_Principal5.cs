namespace DIVULGA_SERVICOS.Migrations
{
    ...
    public partial class Principal5 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.CAD_SUB_CAT_ATIV", t => t.CAD_SUB_CAT_ATIV_CD_SUB_CAT_ATIV)
                .Index(t => t.CAD_SUB_CAT_ATIV_CD_SUB_CAT_ATIV);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.CAD_CATEGORIA", t => new { t.CAD_CATEGORIA_CD_CATEGORIA, t.CAD_CATEGORIA_CD_SERVICO, t.CAD_CATEGORIA_CD_PES_JURIDICA })
                .Index(t => new { t.CAD_CATEGORIA_CD_CATEGORIA, t.CAD_CATEGORIA_CD_SERVICO, t.CAD_CATEGORIA_CD_PES_JURIDICA });
            ...
            CreateTable(
                ...
                c => new
                    {
                        CD_CATEGORIA = c.Long(nullable: false),
                        CD_SERVICO = c.Long(nullable: false),
                        CD_PES_JURIDICA = c.Long(nullable: false),
                        NM_NOME = c.String(nullable: false, maxLength: 255, unicode: false),
                        CAD_SERV_JURIDICA_CD_SERVICO = c.Long(nullable: false),
                        CAD_SERV_JURIDICA_CD_PES_JURIDICA = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => new { t.CD_CATEGORIA, t.CD_SERVICO, t.CD_PES_JURIDICA })
                .ForeignKey("dbo.CAD_SERV_JURIDICA", t => new { t.CAD_SERV_JURIDICA_CD_SERVICO, t.CAD_SERV_JURIDICA_CD_PES_JURIDICA })
                .Index(t => new { t.CAD_SERV_JURIDICA_CD_SERVICO, t.CAD_SERV_JURIDICA_CD_PES_JURIDICA });
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.VEN_ORCAMENTO", t => t.VEN_ORCAMENTO_CD_ORCAMENTO, cascadeDelete: true)
                .ForeignKey("dbo.CAD_SUB_CATEGORIA", t => new { t.CAD_SUB_CATEGORIA_CD_SUB_CATEGORIA, t.CAD_SUB_CATEGORIA_CD_CATEGORIA }, cascadeDelete: true)
                .Index(t => t.VEN_ORCAMENTO_CD_ORCAMENTO)
                .Index(t => new { t.CAD_SUB_CATEGORIA_CD_SUB_CATEGORIA, t.CAD_SUB_CATEGORIA_CD_CATEGORIA });
